...
def main():
    ...
    for bins in range(MIN_BINS, MAX_BINS+1):
        ...
        mlflow_run(accuracy, report, x_train, best_model, best_params, f"Random Forest Classifier Bins {bins}", f"random-forest-classifier-bins-{bins}", feature_names, x_test=x_test, y_test=y_test)
        ...
        mlflow_run(accuracy, report, x_train, best_model, best_params, f"Gradient Boosting Classifier Bins {bins}", f"gradient-boosting-classifier-bins-{bins}", feature_names, x_test=x_test, y_test=y_test)
        time.sleep(SLEEP_TIME)
        ...
        mlflow_run(accuracy, report, x_train, best_model, best_params, f"Support Vector Machine Classifier Bins {bins}", f"support-vector-machine-classifier-bins-{bins}", feature_names, x_test=x_test, y_test=y_test)
        time.sleep(SLEEP_TIME)
        ...
        mlflow_run(accuracy, report, x_train, best_model, best_params, f"K-Nearest Neighbors Classifier Bins {bins}", f"k-nearest-neighbors-classifier-bins-{bins}", feature_names, x_test=x_test, y_test=y_test)
        time.sleep(SLEEP_TIME)
        ...
        mlflow_run(accuracy, report, x_train, best_model, best_params, f"Gaussian Naive Bayes Classifier Bins {bins}", f"gaussian-naive-bayes-classifier-bins-{bins}", feature_names, x_test=x_test, y_test=y_test)
        time.sleep(SLEEP_TIME)
        ...
        mlflow_run(accuracy, report, x_train, best_model, best_params, f"Multinomial Naive Bayes Classifier Bins {bins}", f"multinomial-naive-bayes-classifier-bins-{bins}", feature_names, x_test=x_test, y_test=y_test)
        time.sleep(SLEEP_TIME)
        ...
        mlflow_run(accuracy, report, x_train, best_model, best_params, f"Complement Naive Bayes Classifier Bins {bins}", f"complement-naive-bayes-classifier-bins-{bins}", feature_names, x_test=x_test, y_test=y_test)
        time.sleep(SLEEP_TIME)


def mlflow_run(accuracy, report, x_train, model, best_params, model_name, artifact_path="wine_quality_model", feature_names=None, x_test=None, y_test=None):
